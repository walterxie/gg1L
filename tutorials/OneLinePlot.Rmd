...
Load the example data *model.test* from [ComMA](https://github.com/walterxie/ComMA) package (We only use the example data, *gg1L* doesn't depend it), and display the first 3 rows:
...
It needs to use <code>pdf.gtplot</code> to create pdf, or <code>plot.gtable</code> to plot to console.
