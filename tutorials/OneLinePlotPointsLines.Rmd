...
It is a classical MDS and also known as principal coordinates analysis (Gower, 1966).

```{r PCoA1, warning=FALSE, message=FALSE}
require(vegan)
dist.cm <- vegdist(reads.phyla[,1:6], method="jaccard", binary=TRUE)
cmds <- gtClassicalMDSPlot(dist.cm, reads.phyla[,7, drop=F], colour.id="TaxaGroup", 
...
The basic tutorial of line with points is avaible in another tutorial [**Plot traces**](https://cdn.rawgit.com/walterxie/gg1L/master/tutorials/OneLinePlotPointsLines.html) subsection.
